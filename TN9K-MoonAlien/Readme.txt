Moon Alien Arcade for the Tang Nano 9K FPGA Dev Board. Pinballwiz.org 2025
...
Build:
* Obtain correct roms file for Moon Alien (see scripts in tools folder for rom details).
...
* Open the TangNano9k-MoonAlien project file using GoWin.
